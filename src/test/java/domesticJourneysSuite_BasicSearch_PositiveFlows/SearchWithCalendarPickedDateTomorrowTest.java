...
public class SearchWithCalendarPickedDateTomorrowTest extends BasePage{
	
	public SearchWithCalendarPickedDateTomorrowTest() throws IOException {
		super();
	}
	...
	public void searchWithCalendarPickedDate() throws InterruptedException {
		...
		DomesticJourneysSearchPage.getNextDayTableCell().click();
